...
dir_ic_out='/Volumes/L2/ASTE/INPUTS/inputs_bgc_from_global_BLINGv2/'
...
for var in list_bgc_variables:
	aste_ic.create_ic_regional_llc(var,list_dataset,dir_ic_out + var + '_IC_January_global_blingv2.bin',timestep=0)
