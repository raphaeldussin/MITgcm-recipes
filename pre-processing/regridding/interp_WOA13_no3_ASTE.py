...
woa_global = xr.open_mfdataset(dirwoa + 'woa13_all_n??_01.nc', decode_times=False)
variables2regrid = ['n_an']
...
interpolated1.to_netcdf(dirout + 'WOA_NO3_ASTE_FACET1.nc')
...
interpolated3.to_netcdf(dirout + 'WOA_NO3_ASTE_FACET3.nc')
...
interpolated4.to_netcdf(dirout + 'WOA_NO3_ASTE_FACET4.nc')
...
interpolated5.to_netcdf(dirout + 'WOA_NO3_ASTE_FACET5.nc')
