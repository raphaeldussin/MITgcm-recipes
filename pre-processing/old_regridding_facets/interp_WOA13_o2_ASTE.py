...
woa_global = xr.open_mfdataset(dirwoa + 'woa13_all_o??_01.nc', decode_times=False)
variables2regrid = ['o_an']

def convert_units_clip(dataset, variables):
    for var in variables:
        # convert from WOA to MITgcm BLING units (mL/L -> mol/m3)
        # 1 ml/l = 1e3/22.391 = 44.661 μmol/l
        # 1 ml/L = 1e3/22.391 * 1000 / 1e6 = 0.04466 mol/m3
        dataset[var] = dataset[var] / 22.391
...
interpolated1.to_netcdf(dirout + 'WOA_O2_ASTE_FACET1.nc')
...
interpolated3.to_netcdf(dirout + 'WOA_O2_ASTE_FACET3.nc')
...
interpolated4.to_netcdf(dirout + 'WOA_O2_ASTE_FACET4.nc')
...
interpolated5.to_netcdf(dirout + 'WOA_O2_ASTE_FACET5.nc')
