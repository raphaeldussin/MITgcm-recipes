...
class create_ic():
	...
	def create_ic_regional_llc(self,variable,datasets_facets,fileout,timestep=None,level=None,nx=270,clim=False,\
		...
		if level is not None:
			self._write_ic_to_binary(self.output[:,level,:,:],fileout,precision=precision)
		else:
